          ...
          quickCues: [
            {
              id: 'offline-cue-a',
              actorId: 'A',
              quickCue: '[OFFLINE] Jab tight, rear hand home.',
              whyItMatters: 'Mocked cue — offline mode makes no Gemini call.',
              evidence: [],
              confidence: { score: 0.5, basis: 'heuristic' },
            },
            {
              id: 'offline-cue-b',
              actorId: 'B',
              quickCue: '[OFFLINE] Circle off the fence.',
              whyItMatters: 'Mocked cue — offline mode makes no Gemini call.',
              evidence: [],
              confidence: { score: 0.5, basis: 'heuristic' },
            },
