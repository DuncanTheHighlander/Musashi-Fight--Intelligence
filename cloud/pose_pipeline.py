...
# RTMPose decoding lives in rtmpose_decoder so the SAM 2.1 path can reuse it
# without dragging MediaPipe in. Constants re-exported for existing importers.
from rtmpose_decoder import (  # noqa: F401
    APPROX_BP,
    BP_FROM_HALPE,
    INPUT_H,
    INPUT_W,
...
class PosePipeline:
    ...
    def __init__(self, model_path: str, use_rtmpose: bool = True,
        ...
        self.rtm = RtmPoseDecoder(model_path, providers) if use_rtmpose else None
    ...
    def _rtmpose_in_box(self, frame_bgr, box):
        return self.rtm.infer_in_box(frame_bgr, box) if self.rtm else None
